...
public class DynamicBeat extends JFrame {
	...
	private Image gamejudgementLineImage = new ImageIcon(Main.class.getResource("../images/judgementLine.png")).getImage();
	...
	public DynamicBeat() {
		...
		trackList.add(new Track("Stuff TItle Image.jpg", "Stuff Start Image.jpg", "Stuff Game Image.jpg", 
				"Stuff Selected.mp3", "Stuff - AShamaluevMusic.mp3"));
		trackList.add(new Track("Bold TItle Image.jpg", "Bold Start Image.jpg", "Bold Game Image.jpg", 
				"Bold Selected.mp3", "Bold - AShamaluevMusic.mp3"));
		trackList.add(new Track("Vip TItle Image.jpg", "Vip Start Image.jpg", "Vip Game Image.jpg", 
				"Vip Selected.mp3", "Vip - AShamaluevMusic.mp3"));
		...
		startButton.setBounds(200, 208, 60, 60);
		...
		quitButton.setBounds(200, 336, 60, 60);
		...
		leftButton.setBounds(170, 360, 50, 50);
		...
		rightButton.setBounds(1050, 360, 50, 50);
	...
	public void screenDraw(Graphics2D g) {
		...
		if(isGameScreen)
		{
			...
			g.drawImage(gamejudgementLineImage, 0, 580, null);
			...
			g.drawString("Stuff - AShamaluevMusic", 20, 702);
